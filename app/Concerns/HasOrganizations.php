...
trait HasOrganizations
{
    ...
    public function toOrganizationPermissions(Organization $organization): OrganizationPermissions
    {
        ...
        return new OrganizationPermissions(
            ...
            canCreateShop: $role?->hasPermission(OrganizationPermission::CreateShop) ?? false,
            canUpdateShop: $role?->hasPermission(OrganizationPermission::UpdateShop) ?? false,
            canDeleteShop: $role?->hasPermission(OrganizationPermission::DeleteShop) ?? false,
        );
    }
